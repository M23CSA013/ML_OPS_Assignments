...
def tune_hparams(X_train, Y_train, X_dev, y_dev, list_of_all_param_combination, model_type='svm'):
    ...
    for param_combination in list_of_all_param_combination:
        ...
        if model_type == 'lr':
            curr_model_path = "./models/m23csa013_{}".format(model_type)+"_{}".format(param_combination['solver'])+".joblib"
        ...
        if cur_accuracy > best_accuracy_so_far:
            ...
            if model_type == 'lr':
                ...
                best_model_path = "./models/m23csa013_{}".format(model_type)+"_".join(["_{}".format(v) for k,v in best_hparams.items()])+".joblib"
